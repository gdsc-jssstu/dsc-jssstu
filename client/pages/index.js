                  ...
                  <div className="carousel-inner">
                    <div className="carousel-item active">
                      <div className="carousel-wrapper">
                        ...
                        <img
                          src="https://d33wubrfki0l68.cloudfront.net/819379b9c167409e458b36482a59eb228596c273/4b16e/assets/img/logos/exploreml.png"
                          height="40px"
                        />
                        <h4 className="description">
                          ...
                          Advanced) and relies on university student
                          facilitators to train other students on campus.
                        </h4>
                        <h1
                          id="orange_text"
                          style={{ fontFamily: '"Be Vietnam", sans-serif' }}
                    ...
                    <div className="carousel-item">
                      <div className="carousel-wrapper">
                        ...
                        <img
                          src="https://d33wubrfki0l68.cloudfront.net/4e6c8509967015a695254fa7c4c3d35f449bc401/63e43/assets/img/kit/google_cloud.png"
                          height="40px"
                        />
                        <h4 className="description">
                          #GCPCrashCourse is a Cloud based learning campaign
                          that focuses on building Learning Paths for students
                          across 3 distinct Tracks. With{" "}
                          <span id="blue_text">#GCPCrashCourse</span> you get to
                          learn dedicated topics across three complete tracks,
                          namely - Application Development, Data &amp; Machine
                          Learning.
                        </h4>
                        <h1
                          id="blue_text"
                        ...
                        <a href="gcpcc.html" target="blank">
                          <b></b>
                          <h4 className="description">
                            <b>
                              Click to Sign Up for{" "}
                              <span id="blue_text">#GCPCrashCourse</span>
                            </b>
                          </h4>
                        </a>
                      </div>
                    ...
                    <div className="carousel-item">
                      <div className="carousel-wrapper">
                        ...
                        <img
                          src="https://miro.medium.com/max/4282/1*PshD8n5B_7h-cmmFYpurqA.png"
                          height="40px"
                        />
                        <h4 className="description">
                          Cloud Fest '19 is an occasion which promises to be a
                          celebration of ideas, learning, productive
                          discussions, and the conception of unique solutions to
                          critical real-world problems using cloud computing. It
                          will start off with a keynote sessions by the
                          speakers, and ending with a hands-on session for the
                          participants.{" "}
                        </h4>
                        <h1
                          id="red_text"
