const eventData = [
    ...
    },
    {
        name: "BIOS",
        date: "August 27, 2019",
        discription: "BIOS was the first fun event with more than 230 attendees and 150 being girls which was thus a proud moment for us. The event highlighted about the role of DSC and the virtues of being a part of it. This event centralized its view about the ZERO HOUR Session which focused on the idea behind the DSC club and how it would be beneficial to the students and the society. To make the event more fun and student interactive, we conducted a few activities like Google trends, tower of Hanoi, quiz on the trending technologies, treasure hunt etc.We concluded the event by giving away goodies to the participants encouraging them to stay connected for more exciting events and workshops in the future",
        images: [
