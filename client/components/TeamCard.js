...
const TeamCard = function (props) {
    ...
    return (
        <div className={isFlipped ? "flip-card flipped" : "flip-card"} id="1" onClick={onFlip}>
...
const TeamCardFront = function (props) {
    return (
        <div className="flip-card-front"> <img src={props.faceImage} className="card-img-top" alt="..." />
